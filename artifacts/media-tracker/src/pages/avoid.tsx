        ...
        <Card className="border-dashed border-destructive/20">
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-muted-foreground text-sm max-w-sm">
              When friends warn you about something terrible, record it here so future-you remembers.
            </p>
          </CardContent>
        </Card>
      ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-between">
                      ...
                      <Button
                        size="sm"
                        variant="ghost"
                        className="h-7 px-2 text-xs gap-1 hover:bg-destructive/10 hover:text-destructive self-start mt-2"
                        onClick={() => handleRemove(item.id, item.title)}
                        data-testid={`remove-avoid-${item.id}`}
                      >
